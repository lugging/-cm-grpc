package cm.yuntongxun.grpc.service.hello;
...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "cm.yuntongxun.grpc.service.hello.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest,
      cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest.class,
      responseType = cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest,
      cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest, cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest, cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply.getDefaultInstance()))
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void sayHello(cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest request,
        io.grpc.stub.StreamObserver<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest,
                cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply>(
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
     ...
     * </pre>
     */
    public cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply sayHello(cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply> sayHello(
        cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<cm.yuntongxun.grpc.service.hello.HelloWorldProto.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return cm.yuntongxun.grpc.service.hello.HelloWorldProto.getDescriptor();
    }
